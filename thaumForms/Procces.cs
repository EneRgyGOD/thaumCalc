...
namespace thaumForms
{
    public class Procces
    {
        ...
        public List<string> Calculation(string q)
        {
            quality = q;
            //creating list
            ...
            //node quality
            double y = 1;
            if (quality == "Bright") y = 1.2;
            if (quality == "Normal") y = 1;
            if (quality == "Pale") y = 0.8;
            if (quality == "Fading") y = 0.6;
            ...
            aspects[0] = Math.Round(Result.aer * y);
            aspects[1] = Math.Round(Result.ignis * y);
            aspects[2] = Math.Round(Result.perditio * y);
            aspects[3] = Math.Round(Result.terra * y);
            aspects[4] = Math.Round(Result.aqua * y);
            aspects[5] = Math.Round(Result.ordo * y);
